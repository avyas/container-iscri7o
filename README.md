...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-iscri7o.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-iscri7o.containers.anotherwebservice.com/
...
```
git clone git@github.com:avyas/container-iscri7o.git
cd container-iscri7o
```
...
```
docker attach container-iscri7o
```
